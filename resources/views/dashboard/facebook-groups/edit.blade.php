...
@section('title', 'Sửa Facebook Group')
...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Sửa Facebook Group</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Cập nhật thông tin Group</p>
</div>

<div class="max-w-2xl">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form action="{{ route('dashboard.facebook-groups.update', $group->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="url" name="url" value="{{ old('url', $group->url) }}" required
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="scrape_limit" value="{{ old('scrape_limit', $group->scrape_limit) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="priority" value="{{ old('priority', $group->priority) }}"
                               class="w-full px-4 py-2.5 bg-gray-100 dark:bg-gray-700 border-0 rounded-lg text-sm focus:ring-2 focus:ring-teal-500"
                               placeholder="1">
                ...
                <div class="flex items-center gap-3">
                    <input type="checkbox" name="enabled" id="enabled" value="1" {{ old('enabled', $group->enabled) ? 'checked' : '' }}
